...
export default function TaskForm({ userId, onTaskCreated }: TaskFormProps) {
  ...
  return (
    <form
      ...
      className="bg-white p-6 rounded-lg shadow-md mb-6 border-2 border-blue-500"
    >
      ...
      <input
        ...
        className="w-full p-3 border border-gray-300 rounded-lg mb-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none disabled:opacity-50"
        disabled={loading}
        autoFocus
      />
      ...
      {!showDescription ? (
        ...
        >
          <span>+</span>
          <span>Add notes/description</span>
        </button>
      ) : (
        <textarea
          value={description}
          ...
          className="w-full p-3 border border-gray-300 rounded-lg mb-4 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none resize-none disabled:opacity-50"
          rows={3}
          disabled={loading}
        />
      )}
